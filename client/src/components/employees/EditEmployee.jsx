...
const EditEmployee = () => {
    ...
    //Fetching employee by ID to populate the form 
    useEffect(() => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.put(`http://localhost:5000/api/employees/edit/${id}`, {
                Name: name,
    ...
    return (
        <>
            <Header welcomeMessage="Edit employee" />
